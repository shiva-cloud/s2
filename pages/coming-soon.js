                ...
                <div className="container">
					<div className="text-center">
						...
						<ul className="countdown-social">
							<li className="mr-2"><a href="https://www.facebook.com/" className="fa fa-facebook"></a></li>
							<li className="mr-2"><a href="https://ads.twitter.com/login" className="fa fa-twitter"></a></li>
							<li className="mr-2"><a href="https://in.linkedin.com/" className="fa fa-linkedin"></a></li>
